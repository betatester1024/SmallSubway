...
let upgradeInfo = [
  {cost:10000, mult:1, action:()=>{trainSpeed *= 1.25;}},
  {cost:9000, mult:2, action:()=>{for (train of trains) {train.cap+=2;}; trainLength+=2;}},
  {cost:12000, mult:2, action:()=>{for (stop of stops) {stop.cap+=3;}; stationCap+=3;}},
